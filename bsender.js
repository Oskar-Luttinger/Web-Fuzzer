...
function worker(content, wlist, url) {
    return __awaiter(this, void 0, void 0, function () {
        var result_table, current_keyword, payload, result, content_length, status_code, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (!current_keyword) return [3 /*break*/, 3];
                    payload = inject(content, current_keyword);
