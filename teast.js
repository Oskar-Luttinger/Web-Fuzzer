...
var content = fs.readFileSync(args.path, 'utf-8');
var url = new url_1.URL(args.url);
function TNR(url, payload) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        var wsock, head_buff, body_buff, recvieved;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    wsock = net_1.connect({ host: url.hostname, port: Number(url.port) }, function () { });
                    head_buff = '';
                    body_buff = '';
    ...
    return new Promise(function (resolve, reject) {
        try {
            ...
            wsock_1.on('data', function crec(chunk) {
                buffer_1 += chunk;
                if (buffer_1.length > Number((0, parsers_1.parse_content)(buffer_1)))
