...
### TODO
##### 1. Find out a way to create an array of multiple workers with different parts of the wordlist and call these using promise.Allsettled. Also let the user choose amount of workers DONE
##### 2. Find a way to save results from the workers into a csv file DONE
...
### 6. Make data prettier
### 8. Demonstrate other types of attacks.
